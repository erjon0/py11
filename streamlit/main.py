...
if page == "Home":
    ...
    features = [
        ("rocket", "Project-Based Learning", "Build real applications from day one. Learn by doing with hands-on projects."),
        ("target", "Industry-Ready Skills", "Master the technologies that companies are actually hiring for."),
        ("users", "Expert Instructors", "Learn from developers with 10+ years of industry experience."),
        ("smartphone", "Learn Anywhere", "Access courses on any device, anytime. Your progress syncs automatically."),
        ("award", "Certifications", "Earn recognized certificates to showcase your Python expertise."),
        ("message-circle", "Community Support", "Join 50K+ developers helping each other succeed.")
    ]
    ...
    for i, (icon, title, desc) in enumerate(features):
        with cols[i % 3]:
            ...
            <div class="feature-card">
                <div class="feature-icon">{"🚀" if icon == "rocket" else "🎯" if icon == "target" else "👥" if icon == "users" else "📱" if icon == "smartphone" else "🏆" if icon == "award" else "💬"}</div>
        ...
        with cols[i % 2]:
            ...
            <div class="feature-card" style="margin-bottom: 1rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem;">
                    ...
                    <span style="color: #64748b; font-size: 0.85rem;">{project['time']}</span>
                </div>
...
# ==================== RESOURCES PAGE ====================
    ...
    tab1, tab2, tab3 = st.tabs(["Tutorials", "Cheat Sheets", "Tools"])
...
# ==================== COMMUNITY PAGE ====================
    ...
    # Testimonials
    st.markdown('<h2 class="section-header">What Our Members Say</h2>', unsafe_allow_html=True)
    
    testimonials = [
        {
            "name": "Alex Johnson",
            "role": "Software Engineer at Google",
            "text": "PyTech Hub transformed my career. The project-based approach helped me land my dream job.",
            "rating": 5
        },
        {
            "name": "Maria Garcia",
            "role": "Data Scientist at Netflix",
            "text": "The ML courses are incredibly comprehensive. I went from beginner to deploying models in production.",
            "rating": 5
        },
        {
            "name": "David Kim",
            "role": "Backend Developer at Stripe",
            "text": "The FastAPI course was exactly what I needed. Clear explanations and real-world examples.",
            "rating": 5
        }
    ]
    
    cols = st.columns(3)
    for col, test in zip(cols, testimonials):
        with col:
            st.markdown(f"""
            <div class="testimonial-card">
                <p style="color: #f1f5f9; font-style: italic; margin-bottom: 1rem;">"{test['text']}"</p>
                <div style="color: #3b82f6; font-weight: 600;">{test['name']}</div>
                <div style="color: #64748b; font-size: 0.85rem;">{test['role']}</div>
                <div style="color: #fbbf24; margin-top: 0.5rem;">{"*" * test['rating']}</div>
            </div>
            """, unsafe_allow_html=True)
    ...
    activity_data = pd.DataFrame({
        ...
        'Posts': [320, 450, 380, 520, 480, 290, 210],
        'Replies': [890, 1200, 980, 1350, 1180, 650, 420]
    })
    ...
    fig.add_trace(go.Scatter(x=activity_data['Day'], y=activity_data['Replies'], 
                             mode='lines+markers', name='Replies', 
...
# ==================== CONTACT PAGE ====================
    ...
    st.markdown('<p class="hero-subtitle">Have questions? We would love to hear from you.</p>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        with st.form("contact_form"):
            ...
            if submitted:
                st.success("Thank you for your message! We will get back to you within 24 hours.")
    ...
    with col2:
        ...
        <div class="feature-card">
            <div style="margin-bottom: 1.5rem;">
                <div style="color: #3b82f6; font-weight: 600; margin-bottom: 0.25rem;">Email</div>
                <div style="color: #f1f5f9;">support@pytechhub.com</div>
            </div>
            <div style="margin-bottom: 1.5rem;">
                <div style="color: #3b82f6; font-weight: 600; margin-bottom: 0.25rem;">Discord</div>
                <div style="color: #f1f5f9;">discord.gg/pytechhub</div>
            </div>
            <div style="margin-bottom: 1.5rem;">
                <div style="color: #3b82f6; font-weight: 600; margin-bottom: 0.25rem;">Twitter</div>
                <div style="color: #f1f5f9;">@pytechhub</div>
            </div>
            <div>
                <div style="color: #3b82f6; font-weight: 600; margin-bottom: 0.25rem;">Response Time</div>
                <div style="color: #f1f5f9;">Within 24 hours</div>
            </div>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
        <div class="course-card">
            <div style="color: #f1f5f9;">Monday - Friday</div>
            <div style="color: #94a3b8;">9:00 AM - 6:00 PM EST</div>
        </div>
        """, unsafe_allow_html=True)
